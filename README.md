...
adb shell am start -n com.armusic/com.lalilu.lmusic.agent.ARMusicAgentActivity --es command import_bundle --es path /sdcard/Android/data/com.armusic/files/agent/armusic-agent-import.json
adb pull /sdcard/Android/data/com.armusic/files/agent/armusic-agent-result.json .
```
